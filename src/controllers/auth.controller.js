...
var LoginDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _password_decorators = [(0, swagger_1.ApiProperty)({ example: 'password123' })];
...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        function AuthController_1(jwtService) {
    ...
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _login_decorators = [(0, swagger_1.ApiOperation)({ summary: 'Login to get JWT token (for testing only)' }), (0, swagger_1.ApiResponse)({
                status: 200,
