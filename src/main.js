...
var api_gateway_module_1 = require("./api-gateway.module");
...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, core_1.NestFactory.create(api_gateway_module_1.ApiGatewayModule)];
                case 1:
                    app = _a.sent();
                ...
                case 2:
                    ...
                    console.log("Swagger documentation is available at http://localhost:".concat(port, "/api"));
                    return [2 /*return*/];
            }
        });
    });
